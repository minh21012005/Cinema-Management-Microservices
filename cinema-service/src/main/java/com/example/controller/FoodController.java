...
public class FoodController extends BaseController<Showtime, Long, ShowtimeReqDTO, ShowtimeResDTO> {

    private final ShowtimeService showtimeService;

    protected FoodController(ShowtimeService showtimeService, ShowtimeMapper mapper) {
